...
public class DataMessages {
    ...
    public static final String MESSAGE_FIELD_IS_EMPTY = "Не должно быть пустым";
    ...
    public static final String REG_SYMBOL = "[a-zA-Z]*";
    ...
    public static final String VALID_PASSWORD = "passwordValid";
}
